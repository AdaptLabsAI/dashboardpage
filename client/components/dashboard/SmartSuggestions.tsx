              ...
              {suggestion.avatar ? (
                ...
                <div className="w-14 h-14 bg-[#F5F5F7] rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                    <path d="M17.2772 1.1001H6.72281C3.61181 1.1001 1.08984 3.62206 1.08984 6.73307V17.2874C1.08984 20.3984 3.61181 22.9204 6.72281 22.9204H17.2772C20.3882 22.9204 22.9102 20.3984 22.9102 17.2874V6.73307C22.9102 3.62206 20.3882 1.1001 17.2772 1.1001Z" fill="url(#paint0_linear)"/>
                    <path d="M11.9991 4.08423C10.6362 4.08446 9.29751 4.4436 8.11757 5.12554C6.93762 5.80747 5.95809 6.78813 5.27752 7.96886C4.59695 9.14958 4.23934 10.4887 4.24068 11.8516C4.24202 13.2144 4.60226 14.5528 5.28516 15.7322L4.23047 19.7695L8.33438 18.6825C9.37421 19.2394 10.5274 19.5519 11.7061 19.5963C12.8849 19.6406 14.0582 19.4155 15.1369 18.9382C16.2156 18.4609 17.1713 17.744 17.9313 16.8419C18.6913 15.9397 19.2356 14.8762 19.5228 13.7321C19.81 12.588 19.8326 11.3935 19.5888 10.2394C19.345 9.08524 18.8412 8.0019 18.1158 7.07172C17.3905 6.14153 16.4625 5.38899 15.4026 4.87132C14.3427 4.35364 13.1787 4.08446 11.9991 4.08423Z" fill="white"/>
                    <defs>
                      <linearGradient id="paint0_linear" x1="12" y1="22.9204" x2="12" y2="1.1001" gradientUnits="userSpaceOnUse">
