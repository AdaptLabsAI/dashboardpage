...
const posts = [
  {
    ...
    description:
      "We are excited to be attending the tech conference next month.",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/e2b1c74ce946d15d18c5b7ace4f0982b43694786?width=160",
    platform: "Instagram",
    date: "05 May, 2025",
    time: "04:00 PM",
  ...
  },
  {
    ...
    description:
      "Don't miss our upcoming webinar series focusing on emerging trends in technology.",
    image:
      "https://api.builder.io/api/v1/image/assets/TEMP/e2b1c74ce946d15d18c5b7ace4f0982b43694786?width=160",
    platform: "LinkedIn",
    date: "20 July, 2025",
        ...
        <button className="w-20 h-20 rounded-full bg-gradient-to-br from-brand-green to-brand-dark-green shadow-[0_4px_16px_rgba(0,0,0,0.15)] flex items-center justify-center group hover:scale-105 transition-transform">
          ...
          <div className="relative">
            <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none">
              <path
                d="M32.5 2.5V22.5C32.5 23.163 32.2366 23.7989 31.7678 24.2678C31.2989 24.7366 30.663 25 30 25H20.5578L18.4203 28.7406C18.2016 29.1231 17.8857 29.4411 17.5046 29.6622C17.1234 29.8833 16.6906 29.9998 16.25 29.9998C15.8094 29.9998 15.3766 29.8833 14.9954 29.6622C14.6143 29.4411 14.2984 29.1231 14.0797 28.7406L11.9422 25H2.5C1.83696 25 1.20107 24.7366 0.732233 24.2678C0.263392 23.7989 0 23.163 0 22.5V2.5C0 1.83696 0.263392 1.20107 0.732233 0.732233C1.20107 0.263392 1.83696 0 2.5 0H30C30.663 0 31.2989 0.263392 31.7678 0.732233C32.2366 1.20107 32.5 1.83696 32.5 2.5Z"
                fill="white"
                fillOpacity="0.9"
              />
            </svg>
            ...
            >
              <path
                d="M6.19222 10.3808L6.70415 9.20819C7.1598 8.16472 7.97985 7.33406 9.00278 6.87999L10.4119 6.25448C10.8599 6.05562 10.8599 5.40385 10.4119 5.20499L9.04676 4.59901C7.99752 4.13326 7.16277 3.27185 6.71495 2.19276L6.19636 0.943134C6.00392 0.479404 5.36318 0.479405 5.17075 0.943134L4.65215 2.19274C4.20432 3.27185 3.36955 4.13326 2.32032 4.59901L0.95516 5.20499C0.507135 5.40385 0.507134 6.05562 0.95516 6.25448L2.36433 6.87999C3.38726 7.33406 4.20732 8.16472 4.66293 9.20819L5.17489 10.3808C5.37168 10.8315 5.9954 10.8315 6.19222 10.3808Z"
