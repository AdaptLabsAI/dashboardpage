  ...
  return (
    <div className="bg-gradient-to-b from-white to-brand-green rounded-2xl p-8 h-[395px]">
      <div className="flex items-center gap-3 mb-4">
        ...
        />
        <div>
          <h3 className="text-2xl font-medium text-dark-lighter">Sophia Adam</h3>
        ...
        <div className="ml-auto bg-white rounded-full px-3 py-2 flex items-center gap-1">
          <svg className="w-[14px] h-[14px]" viewBox="0 0 14 14" fill="none">
            <path d="M10.6609 9.61815C12.2262 6.62732 12.2262 3.24347 10.6609 2.06012C9.09555 0.876763 6.55767 2.34201 4.99235 5.33284C3.42703 8.32367 3.42703 11.7075 4.99235 12.8909C6.55764 14.0742 9.09555 12.609 10.6609 9.61815Z" fill="url(#paint0)"/>
            <defs>
              <linearGradient id="paint0" x1="3.97624" y1="8.8765" x2="9.46523" y2="-0.630672" gradientUnits="userSpaceOnUse">
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            <h4 className="text-lg font-medium text-dark-lighter">Social Accounts</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-dark-lighter">+1 23 456 7890</p>
                <p className="text-xs text-dark-lighter/55">WhatsApp Business</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-dark-lighter">+1 23 456 7890</p>
                <p className="text-xs text-dark-lighter/55">Telegram for business</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-dark-lighter">@weareblackrust</p>
